...
class Success extends Component {
    ...
    componentDidMount(){
        ...
        if (keywordCallback.hasOwnProperty("spy_num")) {
            console.log("spyNum 있음!! ");
            this.setState({liarNum: keywordCallback.liar_num, keyword : keywordCallback.keyword , spyNum : keywordCallback.spy_num , isSpy : setting_infos.spy });
        } else {
            console.log("spyNum 없음!! ");
            this.setState({liarNum: keywordCallback.liar_num, keyword : keywordCallback.keyword, isSpy : setting_infos.spy });
        }
    }
